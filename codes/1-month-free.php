...
echo "<button type=\"submit\" name=\"1-month-free\" id=\"1-month-free\">";
...
$unifi_connection = new UniFi_API\Client($controlleruser, $controllerpassword, $controllerurl, $uvs_31df_site_id, $controllerversion);
$set_debug_mode   = $unifi_connection->set_debug($debug);
$loginresults     = $unifi_connection->login();

// Then we create the voucher with the requested expiration value and settings
$voucher_result = $unifi_connection->create_voucher($uvs_31df_expiration, $uvs_31df_count, $uvs_31df_quota, $uvs_31df_note, $uvs_31df_up, $uvs_31df_down, $uvs_31df_limit);
