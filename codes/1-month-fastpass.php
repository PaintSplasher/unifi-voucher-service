...
echo "<button type=\"submit\" name=\"1-month-fastpass\" id=\"1-month-fastpass\">";
...
$unifi_connection = new UniFi_API\Client($controlleruser, $controllerpassword, $controllerurl, $uvs_31dp_site_id, $controllerversion);
$set_debug_mode   = $unifi_connection->set_debug($debug);
$loginresults     = $unifi_connection->login();

// Then we create the voucher with the requested expiration value and settings
$voucher_result = $unifi_connection->create_voucher($uvs_31dp_expiration, $uvs_31dp_count, $uvs_31dp_quota, $uvs_31dp_note, $uvs_31dp_up, $uvs_31dp_down, $uvs_31dp_limit);
