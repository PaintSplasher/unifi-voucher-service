...
echo "<button type=\"submit\" name=\"1-week-fastpass\" id=\"1-week-fastpass\">";
...
$unifi_connection = new UniFi_API\Client($controlleruser, $controllerpassword, $controllerurl, $uvs_7dp_site_id, $controllerversion);
$set_debug_mode   = $unifi_connection->set_debug($debug);
$loginresults     = $unifi_connection->login();

// Then we create the voucher with the requested expiration value and settings
$voucher_result = $unifi_connection->create_voucher($uvs_7dp_expiration, $uvs_7dp_count, $uvs_7dp_quota, $uvs_7dp_note, $uvs_7dp_up, $uvs_7dp_down, $uvs_7dp_limit);
